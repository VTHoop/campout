...
8. **A district may publish more than one calendar** — check explicitly for a school-specific variant before assuming a single district-wide calendar is the whole picture; absence of evidence after checking is fine to record as such in TC, but don't skip the check. **A page section existing is not evidence a program is currently operating.** Chesterfield's calendar page still carries a "2025-26 Bellwood Year-Round Calendar Dates" section — no 2026-27 equivalent exists there — and further research found no Chesterfield school, Bellwood included, actually runs a year-round calendar for 2026-27. Don't draft a calendar from a section just because it's on the page; confirm it's live for the target year first.
